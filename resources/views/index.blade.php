                        ...
                        <li class="list-inline-item">
                            <a href="#">
                                ...
                                <!-- Generator: Adobe Illustrator 19.0.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
                                    ...
                                    <path style="fill:#35AC7C;" d="M256,0c-11.317,0-22.461,0.744-33.391,2.167C348.216,18.53,445.217,125.933,445.217,256s-97.002,237.47-222.609,253.833C233.539,511.256,244.683,512,256,512c141.385,0,256-114.616,256-256S397.385,0,256,0z"/>
                        ...
                        <li class="list-inline-item">
                            <a href="#">
                                <span> {!! '<'.'?'. 'xml  version="1.0"  encoding="iso-8859-1"?>' !!}<!-- Generator: Adobe Illustrator 18.1.1, SVG Export Plug-In . SVG Version: 6.00 Build 0)  --><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                        ...
                                        <g>
                                            <g>
                                                <path style="fill:#35AC7C;" d="M612,116.258c-22.525,9.981-46.694,16.75-72.088,19.772c25.929-15.527,45.777-40.155,55.184-69.411c-24.322,14.379-51.169,24.82-79.775,30.48c-22.907-24.437-55.49-39.658-91.63-39.658c-69.334,0-125.551,56.217-125.551,125.513
        ...
        <div class="row">
            <div class="col-md-12 text-center wow slideInLeft" data-wow-duration="1.5s" style="visibility: visible; animation-duration: 1.5s; animation-name: slideInLeft;">
                ...
                <div class="subscribe wow slideInLeft" data-wow-duration="2s"
                    ...
                    <form>
                        <input type="email" placeholder="Emal address" class="form-control">
                        <button class="btn-primary btn submitBtn" type="submit">subscribe</button>
                    </form>
                </div>
            </div>
        </div>
